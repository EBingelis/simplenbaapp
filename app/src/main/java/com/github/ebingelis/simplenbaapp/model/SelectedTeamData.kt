...
data class SelectedTeamData(val homeTeamFullName: String?, val homeTeamScore: String?, val visitorTeamFullName: String?, val visitorTeamScore: String?)
...
class SelectedTeam {
    ...
    suspend fun getTeamData(id:Int, page: Int = 1): List<SelectedTeamData> {
        ...
        val urlBuilder = "https://www.balldontlie.io/api/v1/games?&team_ids[]=$id".toHttpUrl().newBuilder()
